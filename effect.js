...
$('document').ready(function () {
    ...
    function loopEleven() {
        var randleft = 1000 * Math.random();
        var randtop = 500 * Math.random();
        $('#b110').animate({ left: randleft, bottom: randtop }, 10000, function () {
            loopEleven();
        });
    }
    function loopTwelve() {
    ...
    function loopTwentyTwo() {
        var randleft = 1000 * Math.random();
        var randtop = 500 * Math.random();
        $('#b220').animate({ left: randleft, bottom: randtop }, 10000, function () {
            loopTwentyTwo();
        });
    }
    ...
    $('#balloons_flying').click(function () {
        ...
        $('#b1,#b3,#b5,#b7,#b9,#b10,#b110,#b13,#b15,#b17,#b19,#b21').addClass('balloons-rotate-behaviour-one');
        $('#b2,#b4,#b6,#b8,#b12,#1b4,#b16,#b18,#b20,#b220').addClass('balloons-rotate-behaviour-two');
